...
//    }
    ...
    func dropEntered(info: DropInfo) {
       ...
       /* if pageData.currentPage == nil{
        ...
        // From Index
        let fromIndex = pageData.gradients.firstIndex { (page) -> Bool in
            return page.name == pageData.currentPage?.name
        } ?? 0
        
        // To Index...
        let toIndex = pageData.gradients.firstIndex { (page) -> Bool in
            return page.name == self.page.name
        } ?? 0
        ...
        if fromIndex != toIndex{
            ...
            withAnimation(.default){
                ...
                // Swapping Data...
                let fromPage = pageData.gradients[fromIndex]
                pageData.gradients[fromIndex] = pageData.gradients[toIndex]
                pageData.gradients[toIndex] = fromPage
            }
        }
    }
